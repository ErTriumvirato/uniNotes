<div class="container">
    <header class="row mb-4">
        <div class="col-12">
            <h1 id="titolo-gestione-utenti" class="display-5 fw-bold h2">Gestione utenti</h1>
        </div>
    </header>
        ...
        <div class="card-body p-3 p-md-4">
            ...
            <div class="row g-2 align-items-end collapse d-md-flex mb-4" id="userFiltersCollapse">
                <div class="col-12 col-md-6">
                    <label for="searchUser" class="form-label small fw-semibold">Cerca utente</label>
                    <input type="search" id="searchUser" name="user_search" class="form-control" placeholder='es. "mario_rossi" o "luigi_verdi"' />
                </div>
                <div class="col-12 col-md-6">
                ...
                <div class="modal-body">
                    <form id="userForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="passwordHelp" class="form-text text-secondary">Lascia vuoto per non modificare la password.</div>
                        </div>
                    </form>
                </div>
