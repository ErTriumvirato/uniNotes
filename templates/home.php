...
$ultimiAppunti = $dbh->getHomeArticles($userId, 'data_pubblicazione', 6);
$appuntiPiuVisualizzati = $dbh->getHomeArticles($userId, 'numero_visualizzazioni', 6);
...
<section class="mb-5">
    ...
    <?php if (empty($ultimiAppunti)): ?>
        <p>Nessun appunto trovato.</p>
    <?php else: ?>
        <div class="row g-4">
            <?php foreach ($ultimiAppunti as $appunto): ?>
...
<section>
    ...
    <?php if (empty($appuntiPiuVisualizzati)): ?>
        <p>Nessun appunto visualizzato.</p>
    <?php else: ?>
        <div class="row g-4">
            <?php foreach ($appuntiPiuVisualizzati as $appunto): ?>
                <div class="col-12 col-md-6 col-lg-4">
                    <article class="card h-100 border-0 shadow-sm article-card">
                        <div class="card-body d-flex flex-column">
                            <h3 class="h5 card-title mb-3">
